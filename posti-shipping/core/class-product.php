  ...
  class Product {
    ...
    public function add_product_tabs( $tabs ) {
      /*$tabs[$this->core->prefix] = array( //Disabled, because not required
        'label'   => sprintf(__('%s options', 'woo-topship-africa'), $this->core->vendor_name),
        ...
        'fields' => array(
          array(
            array(
              ...
              'label' => __('HS tariff number', 'woo-topship-africa'),
              'type' => 'text',
              'desc_tip' => true,
              'description' => __('The HS tariff number must be based on the Harmonized Commodity Description and Coding System developed by the World Customs Organization.', 'woo-topship-africa'),
            ),
            array(
              'id' => $this->core->params_prefix . 'country_of_origin',
              'label' => __('Country of origin', 'woo-topship-africa'),
              'type' => 'select',
              'options' => array( '' => '— ' . __('Unknown', 'woo-topship-africa') . ' —' ) + $all_countries,
              'desc_tip' => true,
              'description' => __('The country where the goods originated, e.g. were produced/manufactured or assembled.', 'woo-topship-africa'),
            ),
            array(
              'id' => $this->core->params_prefix . 'dangerous_lqweight',
              'label' => __('DG weight (g)', 'woo-topship-africa'),
              'type' => 'number',
              ...
              'desc_tip' => true,
              'description' => __('Amount of hazardous subtances in the product as grams.', 'woo-topship-africa'),
            ),
          ),
        ),
      );
