...
<body class="wcpk-setup-body wp-core-ui"
    style="background-image: url('<?php echo esc_attr($this->core->setup_background); ?>')">
    <div class="wcpk-setup">
        <h1 id="pakettikauppa-logo">
            <a href="<?php echo esc_html($this->core->vendor_url); ?>" target="_blank" rel="noreferrer noopener"
                aria-label="<?php echo $this->core->text->vendor_website_link_label(); ?>">
                <img src="<?php echo esc_attr($this->core->vendor_logo); ?>"
          ...
          ?>
                <p class="wcpk-setup-actions step">
                    <button type="submit" class="button-primary button button-large button-next"
                        value="pakettikauppa_credentials" name="save_step">
      ...
      ?>
        ...
        <div class="wcpk-setup-settings-wrapper">
          ...
          ?>
                <p class="wcpk-setup-actions step">
                    <button type="submit" class="button-primary button button-large button-next"
                        value="pakettikauppa_merchant_details" name="save_step">
      ...
      ?>
        ...
        <div class="wcpk-setup-settings-wrapper wcpk-shipping-setup">
            ...
            ?>
                ...
                <p class="wcpk-setup-actions step">
                    <button type="submit" class="button-primary button button-large button-next"
                        value="pakettikauppa_shipping_details" name="save_step">
                        <?php echo $this->core->text->btn_continue(); ?>
                    </button>
                </p>
            </form>
      ...
      ?>
        ...
        <div class="wcpk-setup-settings-wrapper">
          ...
          ?>
                <p class="wcpk-setup-actions step">
                    <button type="submit" class="button-primary button button-large button-next"
                        value="pakettikauppa_order_processing" name="save_step">
                        <?php echo $this->core->text->btn_continue(); ?>
                    </button>
                </p>
            </form>
