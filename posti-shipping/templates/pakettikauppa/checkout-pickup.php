...
<tr class="shipping-pickup-point">
  <th><?php esc_attr_e('Pickup point', 'woo-topship-africa'); ?></th>
  <td data-title="<?php esc_attr_e('Pickup point', 'woo-topship-africa'); ?>">
    ...
    <?php endif; ?>
    <?php if ( $pickup['show'] ) : ?>
      <span><?php esc_html_e('Choose one of pickup points close to the address you entered:', 'woo-topship-africa'); ?></span>
...
<?php if ( $custom['show'] ) : ?>
  <tr class="shipping-custom-pickup-point">
    ...
    <td data-title="<?php echo $custom['title']; ?>">
      ...
      <button type="button" onclick="pakettikauppa_custom_pickup_point_change(pakettikauppacustom_pickup_point)" class="btn" id="pakettikauppacustom_pickup_point_btn"><i class="fa fa-search"></i><?php esc_html_e('Search', 'woo-topship-africa'); ?></button>
